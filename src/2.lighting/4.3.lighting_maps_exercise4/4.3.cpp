...
int main() {
	...
	//初始化shader程序
	Shader lightingShader("shader/2/4.3.lighting_maps.vs", "shader/2/4.3.lighting_maps.fs");
	Shader lampShader("shader/2/4.3.lamp.vs", "shader/2/4.3.lamp.fs");
	...
	unsigned int emissionMap = loadTexture(
		FileSystem::getPath("resources/textures/matrix.jpg").c_str());
